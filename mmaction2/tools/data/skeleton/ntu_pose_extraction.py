...
args.det_config = 'posec3d-video-structuralize/mmaction2/demo/demo_configs/faster-rcnn_r50_fpn_2x_coco_infer.py'  # noqa: E501
...
args.det_score_thr = 0.9
args.pose_config = 'posec3d-video-structuralize/mmaction2/demo/demo_configs/td-hm_hrnet-w32_8xb64-210e_coco-256x192_infer.py'  # noqa: E501
...
def ntu_pose_extraction(vid, skip_postproc=False):
    ...
    anno['label'] = int(vid.split('/')[-1].split('_')[0][:3])
    # anno['label'] = 0
    tmp_dir.cleanup()
